...
>
> **Note on the FPGA core.** The MCS-48 emulation described in this work incorporates the OpenCores `t48` core (used unmodified), which is distributed under the **GPL-2.0** license. The corresponding HDL is not redistributed here; this repository contains only the paper, the report, the slides, and the verification artefacts.
