<p align="center">
  <img src="docs/social_preview.svg?v=5" alt="Ensuring Functional Equivalence in Retrofitted Anti-Skid Systems for European Public Transportation" />
</p>
...
![FPGA](https://img.shields.io/badge/FPGA-FF6F00?style=for-the-badge&logo=xilinx&logoColor=white)
...
| **Date** | August 2025 |
| **Publication** | *Kölner Beiträge zur technischen Informatik* (ISSN 2193-570X), VIMS 2026 |
...
│  │  │ (t48_core)        │  │(SFH601-3│  │ Logger   │  │ (Battery) │  │   │
│  │  ├───────────────────┤  │  ×4)    │  └──────────┘  └───────────┘  │   │
│  │  │ Flash ROM         │  │         │  ┌──────────┐                  │  │
│  │  │ (S29AL016J)       │  │         │  │ USB      │                  │  │
│  │  ├───────────────────┤  │         │  │ Type-C   │                  │  │
...
│  │  │ (CY14B104NA)      │  │         └────────────────────────────────┘  │
│  │  ├───────────────────┤  │         │                                   │
│  │  │ Freq. Sweep Gen.  │  │         │  PCB 4: LED DISPLAY BOARD         │
│  │  │ (850–1550 Hz)     │  │         ┌────────────────────────────────┐  │
│  │  ├───────────────────┤  │   BCD   │  CD4511BE → 7-Seg Displays    │   │
│  │  │ Watchdog + BOD    │──┼────────→│  (SC03-12EWA × 2)             │   │
│  │  │ (BOD: TPS3307)    │  │         └────────────────────────────────┘  │
│  │  └───────────────────┘  │         │                                   │
│  └─────────────────────────┘         │  PCB 2: UPPER BOARD               │
│                                      ┌────────────────────────────────┐  │
│  Power: TPS73615 (1.5V)              │  Buttons: Test, STW, Lösch,    │  │
│         TPS73633 (3.3V)              │  Tür/V + Debounce + Level Shift│  │
...
│   ├── deck_frames.tex     # Frames (presentation + handout build from these)
│   ├── presentation.tex    # Deck driver
│   └── handout.tex         # Printable-handout driver
...
Compiled PDFs are staged under `.tmp.nosync/dist/` locally and are **not** tracked in Git. The CI pipeline builds them on every push and attaches the paper, report, and slides to each tagged release — download them from the [latest release](https://github.com/mtorun0x7cd/anti-skid-verification/releases/latest).
...
His work spans the verification and validation of safety-critical systems, infrastructure hardening, and cryptographic integrity, grounded in an M.Sc. in Computer Science and Systems Engineering from TH Köln. This repository accompanies active research toward publication.
