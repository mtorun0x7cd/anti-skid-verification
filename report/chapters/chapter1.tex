...
\begin{enumerate}[label=\arabic*.]
	...
	\item Establish Verifiable Compliance: Generate comprehensive verification and certification artefacts that rigorously demonstrate the retrofitted system's functional equivalence to the original \texttt{WGMC19} design~\cite{rexroth1992wgmc19} and its compliance with current functional safety standards (including~\gls{iec61508}, \gls{en50129}, \gls{en50155}, \gls{en50716}, and~\gls{ieee1012}).
...
The scope is focused on the board-level retrofit of the \texttt{WGMC19} test-diagnosis module and the development of a verification methodology suitable for demonstrating functional equivalence and compliance for this type of safety-critical component. While full system-level~\gls{hil} testing rigs were beyond the project's resources, the testing framework is designed to align with~\gls{hil} principles to facilitate future integration.
