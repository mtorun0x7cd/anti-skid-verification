...
\begin{itemize}
  ...
  \item \textbf{Layer 2 --- Scenario-based system-level testing (black-box).} The fully integrated board exercised through a dedicated hardware fixture with machine-parseable YAML test cases and implicit traceability to the legacy functional requirements.
\end{itemize}
